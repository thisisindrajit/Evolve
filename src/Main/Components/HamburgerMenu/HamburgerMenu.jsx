              ...
              >
                {({ close }) => (
                  <div className="flex flex-col gap-5">
                    {/* Home icon */}
                    <div
                      className="flex gap-2.5 w-36 hover:p-3 rounded-md hover:bg-dark-green transition-all"
                      onClick={() => {
                        props.setpage(1);
                        close();
                      }}
                    >
                      <Icon
                        height={18}
                        width={18}
                        fill={props.currentpage === 1 ? "yes" : "no"}
                        noIconCSS
                      >
                    ...
                    >
                      <Icon
                        height={18}
                        width={18}
                        fill={props.currentpage === 2 ? "yes" : "no"}
                        noIconCSS
                      >
                        <ellipse
                          cx="19.611"
                    ...
                    >
                      <Icon
                        height={18}
                        width={18}
                        fill={props.currentpage === 3 ? "yes" : "no"}
                        noIconCSS
                      >
                        {props.currentpage !== 3 ? (
                          <>
                    ...
                    >
                      <Icon
                        height={18}
                        width={18}
                        fill={props.currentpage === 4 ? "yes" : "no"}
                        noIconCSS
                      >
                        {props.currentpage !== 4 ? (
                          <>
