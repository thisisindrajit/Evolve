...
const BondDeleteOverlay = (props) => {
  ...
  let deleteBond = async () => {
    ...
    const DELETE_ENDPOINT = process.env.REACT_APP_API_URL + "addEditDelBond.php";
  ...
  return (
    <div
      id="delete-overlay"
      style={{ height: Math.max(220, props.height + 10) + "px" }}
    >
      <div id="delete-content">
        ...
        <button
          ...
          style={{ backgroundColor: "red", marginTop: "25px" }}
        ...
        <button
          className="delete-button"
          style={{
            border: text === "Delete" ? "1px solid #14cccc" : "1px solid #ccc",
          }}
